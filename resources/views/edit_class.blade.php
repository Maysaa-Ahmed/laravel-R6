      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="" method="POST" class="px-md-5">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <textarea id="" cols="30" rows="5" class="form-control py-2" name="timeFrom">{{$class->timeFrom}}</textarea>
            </div>
          </div>
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">Time To:</label>
            <div class="col-md-10">
              <textarea id="" cols="30" rows="5" class="form-control py-2" name="timeTo">{{$class->timeTo}}</textarea>
            </div>
          </div>
          <hr>
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="checkbox" class="form-check-input" style="padding: 0.7rem;" name="published" @checked($class->isFulled) />
            </div>
          </div>
